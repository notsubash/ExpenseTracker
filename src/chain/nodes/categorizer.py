...
class CategoryData(BaseModel):
    category: str = Field(description="The selected category for the invoice")
...
def categorize_invoice(state):
    ...
    prompt = (
        ...
        f"VAT: {receipt_vat}\n"
        f"Business/Personal: {receipt_business_personal}\n"
    ...
    new_state["selected_category"] = selected_category
